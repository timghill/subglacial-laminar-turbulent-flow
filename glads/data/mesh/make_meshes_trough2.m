...
bmark = [2;2;2;2;1];         % just a mark which is given to the nodes on the boundary
bmark_edge = [2;2;2;2;2];  % just a mark which is given to the edges on the boundary

maxareas = 250000000*[0.1, 0.01, 5e-3, 1.995e-3]; % area of triangle , 1e-4
...
save([mfiledir, '/mesh_v1.mat'], 'meshes');
