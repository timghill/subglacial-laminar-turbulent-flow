function melt = KAN_moulin_diurnal(t, pin, dmesh, ii_moulin, catchmap)
    % KAN_MOULIN_DIURNAL
    %
    % melt = KAN_moulin_diurnal(time, pin, dmesh, ii_moulin, catchmap)
    %
    % Compute moulin inputs for KAN_L forcing case with seasonl
